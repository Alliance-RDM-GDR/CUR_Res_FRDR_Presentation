---
title: "Introduction aux services nationaux de GDR"
subtitle: "Dépôt fédéré de données de recherche (DFDR)"
author: 
...
## Page de renvoi de l'ensemble de données {.center}

::: {style="text-align: left;font-size: 90%"}
- Conditions d'utilisation
- Télécharger des données
- LICENCE et sommes de contrôle (checksums)
...
## Soutien aux chercheurs {.center}

::: {style="text-align: left;font-size: 90%"}
**Au sein de votre établissement :**
- Vos bibliothécaires spécialisés en données de recherche.

**Ressources en ligne :**
- Documentation du DFDR et modèles de fichier README (EN/FR).

**L'équipe du DFDR :**
- {{< bi envelope >}} Contact : `support@frdr-dfdr.ca`
- Consultations avant le dépôt.
- Soutien continu après la publication.
:::
